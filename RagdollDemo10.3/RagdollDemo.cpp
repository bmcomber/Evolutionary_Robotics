...
void RagdollDemo::initPhysics()
{
    ...
    ifstream inFile;
    inFile.open("/Users/bmcomber/Assignment10.3/weights3.dat");
	string line;
    for(int j=0; j<6; j++){
		for(int i=0; i<12; i++){
...
#define CREATE_GROUND_COLLISION_OBJECT 1
    ...
    //x-positive (left)
    CreateCylinder(3, 2., 2., -1.25, .2, 1., 0., 0., M_PI_2);   //1st leg left horizontal
    CreateCylinder(7, 3., 1., -1.25, .2, 1., 0., 0., 0.);     //1st leg vertical
    
    CreateCylinder(1, 2. , 2., 0., .2, 1., 0., 0., M_PI_2); //2nd leg left horizontal
    CreateCylinder(5, 3.0, 1., 0., .2, 1., 0., 0., 0.);     //2nd leg left vertical
    
    
    CreateCylinder(11, 2., 2., 1.25, .2, 1., 0., 0., M_PI_2);    //3rd leg left horizontal
    CreateCylinder(9, 3., 1., 1.25, .2, 1., 0., 0., 0.);     //3rd leg left vertical
    
    
    //x-negative (right)
    CreateCylinder(2, -2., 2., -1.25, .2, 1., 0., 0., M_PI_2);   //1st leg right horizontal
    CreateCylinder(6, -3.0, 1., -1.25, .2, 1., 0., 0., 0.);      //1st leg right vertical
    
    CreateCylinder(4, -2., 2., 0., .2, 1., 0., 0., M_PI_2);   //2nd leg right horizontal
    CreateCylinder(8, -3., 1., 0., .2, 1., 0., 0., 0.);    //2nd leg right vertical
    
    CreateCylinder(12, -2., 2., 1.25, .2, 1., 0., 0., M_PI_2);   //3rd leg right horizontal
    CreateCylinder(10, -3., 1., 1.25, .2, 1., 0., 0., 0.);    //3rd leg right vertical
    ...
    btVector3 local10 = PointWorldToLocal(10, btVector3(-3., 2., 0.));
    ...
    btVector3 localAxis11 = AxisWorldToLocal(11, btVector3(0., 0., -1.));
...
void RagdollDemo::clientMoveAndDisplay()
{
    ...
    if(timeStep == 1000)
    {
        ...
        //printf("%f %f %f\n", pos.x(), pos.y(), pos.z());
        ofstream myfile;
        myfile.open ("/Users/bmcomber/Assignment10.3/fits3.dat");
        myfile << pos.z();
        myfile.close();
        exit(0);
    }
