...
#define CREATE_GROUND_COLLISION_OBJECT 1
    ...
    CreateCylinder(1, 1.65, 1., 0., .2, .65, 0., 0., M_PI_2);
    CreateCylinder(2, -1.65, 1., 0., .2, .65, 0., 0., M_PI_2);
    CreateCylinder(3, 0, 1., 1.65, .2, .65, M_PI_2, 0., 0.);
    CreateCylinder(4, 0, 1., -1.65, .2, .65, M_PI_2, 0., 0.);
    CreateCylinder(5, 2.30, .5, 0., .2, .65, 0., 0., 0.);
    CreateCylinder(6, -2.30, .5, 0., .2, .65, 0., 0., 0.);
    CreateCylinder(6, 0., .5, 2.30, .2, .65, 0., 0., 0.);
    CreateCylinder(6, 0., .5, -2.30, .2, .65, 0., 0., 0.);
